...
public class B68UIFloatLabelTextField: UITextField {
  ...
  */
  @IBInspectable public var activeTextColorfloatingLabel : UIColor = UIColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 0.5) {
    didSet {
  ...
  */
  @IBInspectable public var inactiveTextColorfloatingLabel : UIColor = UIColor(white: 1.0, alpha: 0.5) {
    didSet {
